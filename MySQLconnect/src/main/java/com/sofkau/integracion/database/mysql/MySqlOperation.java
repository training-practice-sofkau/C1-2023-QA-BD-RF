package com.sofkau.integracion.database.mysql;

import com.sofkau.integracion.database.DataBase;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

import static com.sofkau.integracion.database.mysql.MySqlConstants.CONNECTION_STRING;
import static com.sofkau.integracion.database.mysql.MySqlConstants.MY_SQL_JDBC_DRIVER;
